...
Проект представляет собой основу для Telegram-бота, который проверяет подписку на ваш канал и после этого выдает готовую VPN subscription-ссылку для Xray-клиентов.
...
Отправьте команду `/start` боту в Telegram, подпишитесь на канал и убедитесь, что после проверки подписки бот отправляет subscription-ссылку и кнопки для быстрого или ручного подключения.
